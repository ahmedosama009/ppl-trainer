...
function wire() {
  ...
  app.onclick = ev => {
    ...
    if (d.jump) {
      ...
      jumpTo(i); view = 'today'; render(); return;
    }
  ...
  app.onchange = ev => {
    ...
    if (t.id === 'setpos') { jumpTo(+t.value); render(); return; }
...
document.addEventListener('click', ev => {
  ...
  if (ev.target.closest('#gotoday')) { view = 'today'; render(); return; }
});
